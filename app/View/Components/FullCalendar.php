...
class FullCalendar extends Component
{
     ...
     * @param  array|string|null $config Eventos do calendário, pode ser um array de eventos ou uma URL para buscar eventos via AJAX. Se for um array, deve conter objetos com propriedades como 'title', 'start', 'end', 'color' e 'editable'. Se for uma string, deve ser a URL para buscar os Endpoints de eventos.
